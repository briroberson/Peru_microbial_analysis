...
PCoALIA<-ggplot(metalia, aes(axis01, axis02)) +
  ...
  xlab("PCoA 1") +
  ylab("PCoA 2") +
  labs(colour = "Treatment", title='LIA', subtitle='with top 10 Simper') +
  theme_bw()
PCoALIA
#export the plot to a powerpoint to edit
...
PCoARGMw<-ggplot(metargmW, aes(axis01, axis02)) +
  ...
  xlab("PCoA 1") +
  ylab("PCoA 2") +
  labs(colour = "Treatment", title='RGM Wet', subtitle='top 10 Simper') +
  theme_bw()
PCoARGMw
...
metaDryRGM<- metadata_RGMF %>% 
  ...
  filter(!`SampleID` %in% c('11B', '19B', '23', '49', '7')) #samples filtered in line 92 of 18s_Analysis 
...
PCoArgmD<-ggplot(metaDryRGM, aes(axis01, axis02)) +
  ...
  xlab("PCoA 1") +
  ylab("PCoA 2") +
  labs(colour = "Treatment", title='RGM Dry', subtitle='top 10 Simper') +
  theme_bw() 
PCoArgmD
